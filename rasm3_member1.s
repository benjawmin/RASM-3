...
eqIC:
	...
	bl	strcasecmp		// compare ignore case S1 and S3
...
eqIC2:
	...
	bl	strcasecmp		// compare ignore case S1 and S2
...
cpyString:
	...
	bl	strcpy			// strcpy copies X1 to dest X0
...
// DOES S1 AT LOCATION 11 START WITH "hat." ----------------------------- 10
	...
	bl	strrchr			// returns the first occurence of hat
...
Num11:
	...
	bl	strstr			// strstr looks for a strin within a string
...
Num12:
	...
	bl	strrchr			// returns the last occuence of the string we are loocking for
